    ...
    <div class={styles.App}>
      <div class={styles.sidebar}>
        ...
        <div class="mt-20 flex flex-col items-center">
          <a href="https://discord.gg/5ptAqtpyvh" target="_blank">
            <button class={styles.secondarybutton}>Discord Community</button>{" "}
          </a>
          <a href="https://docs.zerops.io/" target="_blank">
            <button class={styles.primarybutton}>Zerops Docs</button>
          </a>
        </div>
      </div>
      <div class={styles.main}>
        <div class="p-1 ml-5 mt-52 mb-8">
          <div class=" mb-10">
            <p class="text-xl font-medium text-[#477ABE] bg-[#EEF4FA] border border-dashed border-[#97C6F7] max-w-3xl px-4 py-3 rounded-sm">
              _💡 Check out our other{" "}
              <a
                href="https://www.github.com/zeropsio"
                target="_blank"
                class="font-semibold"
              >
                recipes / examples
              ...
              and test them on{" "}
              <a href="https://zerops.io" target="_blank" class="font-semibold">
                Zerops
              </a>
            </p>
          </div>
          <div>
            <h1 class="text-6xl font-semibold justify-start mb-6">
              Solid.js + Zerops
            </h1>
            <hr class="border-[#E0EFFF]"></hr>
            <div class="text-[#568FCB] text-2xl font-medium mt-8">
              <p class="max-w-4xl">
                A Static Solid.js example for Zerops which you can deploy in 2
                simple steps (Technically, we don't count Ctrl + V... but who's
                checking?).{" "}
              </p>
